...
test.describe('Hero Component E2E', () => {
  ...
  test.describe('Animations', () => {
    ...
    test('should animate badge pulse', async ({ page }) => {
      ...
      const initialOpacity = await badge.evaluate((el: any) =>
      ...
      const finalOpacity = await badge.evaluate((el: any) =>
        window.getComputedStyle(el).opacity
      );
    ...
    test('should animate particles', async ({ page }) => {
      ...
      const { container } = page.locator('body').evaluate((el: any) => ({
        container: el,
      }));
  ...
  test.describe('Responsiveness', () => {
    ...
    test('should have responsive font sizes', async ({ page }) => {
      ...
      const fontSize = await headline.evaluate((el: any) =>
  ...
  test.describe('Visual Design', () => {
    test('should display gradient text effect on headline', async ({ page }) => {
      ...
      const style = await headline.evaluate((el: any) =>
    ...
    test('should display pipeline container with border', async ({ page }) => {
      ...
      const border = await pipeline.evaluate((el: any) =>
  ...
  test.describe('Accessibility', () => {
    ...
    test('should have sufficient color contrast', async ({ page }) => {
      ...
      const color = await headline.evaluate((el: any) =>
