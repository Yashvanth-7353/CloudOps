...
describe('Features Component', () => {
    ...
    describe('Content Verification', () => {
        ...
        it('should have feature cards with correct sizes', () => {
            ...
            const sizes = Array.from(cards).map(card => {
                if (card.classList.contains('feature-card-large'))
                    return 'large';
                if (card.classList.contains('feature-card-medium'))
                    return 'medium';
                if (card.classList.contains('feature-card-small'))
                    return 'small';
                return 'unknown';
            });
    ...
    describe('Styling', () => {
        it('should have correct section background', () => {
            const { container } = render(_jsx(Features, {}));
        ...
        it('should have CTA button with gradient background', () => {
            render(_jsx(Features, {}));
            const ctaButton = document.querySelector('.features-cta-button');
    ...
    describe('Icons', () => {
        ...
        it('should have correct icon styling', () => {
            render(_jsx(Features, {}));
            const iconContainer = document.querySelector('.feature-card-icon');
