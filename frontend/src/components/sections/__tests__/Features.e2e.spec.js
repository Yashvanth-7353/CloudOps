...
test.describe('Features Section E2E', () => {
    ...
    test.describe('Feature Cards', () => {
        ...
        test('should have glassmorphism styling on cards', async ({ page }) => {
            ...
            const style = await glassEffect.evaluate((el) => ({
